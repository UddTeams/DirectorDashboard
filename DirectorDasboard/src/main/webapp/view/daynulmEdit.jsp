               ...
               <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="sep_i" class="form-control" id="sep_i" placeholder="Enter sep_i">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">ShgBl</label>
                    <input type="text" name="shg_bl" class="form-control" id="shg_bl" placeholder="Enter shg_bl">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Shg Formation</label>
                    <input type="text" name="shg_formation" class="form-control" id="shg_formation" placeholder="Enter shg_formation  ">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Shg Revolving Fund</label>
                    <input type="text" name="shg_revolving_fund" class="form-control" id="shg_revolving_fund" placeholder="Enter shg_revolving_fund">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alf Formation</label>
                    <input type="text" name="alf_formation" class="form-control" id="alf_formation" placeholder="Enter alf_formation">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alf Revolving Fund</label>
                    <input type="text" name="alf_revolving_fund" class="form-control" id="alf_revolving_fund" placeholder="Enter alf_revolving_fund">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pmfme Shg</label>
                    <input type="text" name="pmfme_shg" class="form-control" id="pmfme_shg" placeholder="Enter pmfme_shg">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pmsva Nidhi</label>
                    <input type="text" name="pmsva_nidhi" class="form-control" id="pmsva_nidhi" placeholder="Enter pmsva_nidhi">
                  </div>
...
<script type="text/javascript">
  ...
  $("#btn").click(function(){
   ...
   var pmsva_nidhi=$('#pmsva_nidhi'). val(); 
    ...
    var data_json = {"ulbName":ulb_name ,  "year":financial_year ,  "month":month , "sepI":sep_i ,  "shgBl":shg_bl ,  "shgFormation":shg_formation ,  "shgRevolvingFund":shg_revolving_fund ,  "alfFormation":alf_formation ,  "alfRevolvingFund":alf_revolving_fund ,  "pmfmeShg":pmfme_shg ,  "pmsvaNidhi":pmsva_nidhi,  "extra":"DAYNULM"};
