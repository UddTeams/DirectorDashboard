              ...
              <div id="quickForm">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="self_blc_acc_count" class="form-control" id="self_blc_acc_count" placeholder="Enter self_blc_acc_count">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Progress Blc Acc Count</label>
                    <input type="text" name="progress_blc_acc_count" class="form-control" id="progress_blc_acc_count" placeholder="Enter progress_blc_acc_count">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Complete Blc Acc Count</label>
                    <input type="text" name="complete_blc_acc_count" class="form-control" id="complete_blc_acc_count" placeholder="Enter complete_blc_acc_count">
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  $("#btn").click(function(){
   ...
   var complete_blc_acc_count=$('#complete_blc_acc_count'). val(); 
    ...
    var data_json = {"ulbName":ulb_name ,  "year":financial_year ,  "month":month ,  "selfBlcAccCount":self_blc_acc_count ,  "progressBlcAccCount":progress_blc_acc_count ,  "completeBlcAccCount":complete_blc_acc_count , "extra":"PMAYHFA"};
