  ...
  <div class="col-md-12">
    ...
    <!-- STACKED BAR CHART -->
            <div class="card card-success" >
              <div class="card-header">
                <h3>Total Applications</h3><br>

                
  From:<input type="date" id="from1" name="from1" style="width: 10%; margin: 10px;">
  To:<input type="date" id="to1" name="to1" style="width: 10%; margin: 10px;">

  Select ULB:<select name="ulb1w" id="ulb_name" style="width: 10%;margin: 10px;">
  
  </select>

  Select Module:<select name="sm3" id="sm3" style="width: 10%;margin: 10px;">
    <option value="pt">Property Tax</option>
    <option value="tl">Trade Licence</option>
    <option value="mcs">MCS</option>
  </select>
 <!-- Select Status:<select name="status" id="status" style="width: 10%;margin: 10px;">
    <option value="Pending">Pending</option>
    <option value="Completed">Completed</option>
    <option value="Canceled">Canceled</option>
    <option value="Total">Total</option>
  </select>--!>
  <button id="totalApp">Apply</button>
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3>Total Collection</h3>
                 ...
                 From:<input type="date" id="from2" name="from2" style="width: 10%; margin: 10px;">
  To:<input type="date" id="to2" name="to2" style="width: 10%; margin: 10px;">

  Select ULB:<select name="ulb1wsa" id="ulb_name1" style="width: 10%;margin: 10px;">

     
  
  </select>
  Select Module:<select name="sm4" id="sm4" style="width: 10%;margin: 10px;">
    <option value="pt">Property Tax</option>
    <option value="tl">Trade Licence</option>
    <option value="mcs">MCS</option>
  </select>
 <!-- Select Status:<select name="cars" id="cars" style="width: 10%;margin: 10px;">
    <option value="volvo">Pending</option>
    <option value="saab">Completed</option>
    <option value="opel">Cancelled</option>
  </select> --!>
  <button id="totalColl">Apply</button>
              ...
              <div class="card-body p-0" id="tr4" style="display: none;">
                <div class="table-responsive">
                  <table class="table m-0" style="background: #c6c6c6;">
                    ...
                    <tbody>
                    <tr>
                      <td><a>1. GIS Master Plan 2041</a></td>
                      <td></td>
                      <td></td>
                      <td>
