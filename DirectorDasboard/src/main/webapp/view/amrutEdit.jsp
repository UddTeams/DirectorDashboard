          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div id="quickForm">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">GIS Master Plan 2041</label>
                    <input type="text" name="gis_master_plan_2041" class="form-control" id="gis_master_plan_2041" placeholder="Enter gis_master_plan_2041">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Water Supply</label>
                    <input type="text" name="water_supply" class="form-control" id="water_supply" placeholder="Enter water_supply">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Sewerage</label>
                    <input type="text" name="sewerage" class="form-control" id="sewerage" placeholder="Enter sewerage">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Drainage</label>
                    <input type="text" name="drainage" class="form-control" id="drainage" placeholder="Enter drainage">
                  </div>
                </div>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Parks</label>
                    <input type="text" name="parks" class="form-control" id="parks" placeholder="Enter parks">
                  </div>
                </div>
